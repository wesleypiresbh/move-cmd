...
<<<<<<< HEAD
          <Link href="/MOVECMDSYS/Move-CMD-passageiro" className="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-slate-100 hover:border-orange-500 hover:shadow-md transition-all group">
=======
...
>>>>>>> 5f44078 (Atualiza rotas separadas para admin, motorista e passageiro)
...
<<<<<<< HEAD
          <Link href="/MOVECMDSYS/Move-CMD-motorista" className="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-slate-100 hover:border-blue-500 hover:shadow-md transition-all group">
=======
...
<<<<<<< HEAD
          <Link href="/MOVECMDSYS/Move-CMD-Admin" className="flex flex-col items-center justify-center p-6 bg-white rounded-2xl shadow-sm border border-slate-100 hover:border-emerald-500 hover:shadow-md transition-all group">
=======
